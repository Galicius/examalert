...
export async function initDB() {
  ...
  await query(`CREATE INDEX IF NOT EXISTS idx_learning_sessions_date ON learning_sessions(session_date);`);
  ...
  await query(`CREATE INDEX IF NOT EXISTS idx_participants_session ON session_participants(session_id);`);
  await query(`CREATE INDEX IF NOT EXISTS idx_participants_user ON session_participants(user_id);`);
